package sg.edu.rp.c346.id20015553.demotodolist;
...
public class MainActivity extends AppCompatActivity {
    ...
    sg.edu.rp.c346.id20015553.demoandroidlist.CustomAdapter caToDo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        caToDo = new sg.edu.rp.c346.id20015553.demoandroidlist.CustomAdapter(this, R.layout.row, alToDoList);
